    ...
    const fetchMetrics = async () => {
      try {
        ...
        if (Array.isArray(res.data)) {
          complaints = res.data;
        } else if (res.data.success && Array.isArray(res.data.data.complaints)) {
    ...
    <div className="min-h-screen flex bg-gradient-to-br from-blue-50 via-white to-blue-50 overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="p-8 font-extrabold text-2xl tracking-wide flex items-center gap-2"
        >
          <svg
        ...
        <motion.div
          ...
          className="p-6 border-t border-blue-700/50 bg-blue-900/30 mt-auto rounded-br-3xl"
        >
